...
public class ModProperties {
	...
	// Mod info page
	public static final String COLORED_NAME = EnumChatFormatting.DARK_PURPLE + "Mysterium" + EnumChatFormatting.GREEN + "Lib ";
	...
	public static final String DESCRIPTION = EnumChatFormatting.GRAY + "A library mod used for multiple things including easy ASM fixes and more.";
	...
	public static final String[] SPLASH_OF_THE_DAY = new String[] {
			...
			"Creeper? Awww man.",
			"Also try ImmersiveCavegen.",
			"Also try RPGStamina.",
			"Also try NoLeafDecay.",
			"Also try our other mods.",
			"Finally released as a standalone mod!",
			"2.0.0.0, also known as the first standalone version or 1.1.",
			"Better than ever!",
